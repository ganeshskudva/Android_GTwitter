# Project 3 - *Android_GTwitter*

**GTwitter** is an android app that allows a user to view his Twitter timeline and post a new tweet. The app utilizes [Twitter REST API](https://developer.twitter.com/en/docs/api-reference-index).
...
* [x] User can favorite any tweet

## Video Walkthrough

Here's a walkthrough of implemented user stories:

<img src='Twitter_Client.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />
